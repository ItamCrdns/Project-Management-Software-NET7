...
namespace CompanyPMO_.NET.Migrations
{
    ...
    [Migration("20240603163921_remove-image-table-added-pictures-table-for-projects-company-and-tasks-tables")]
    partial class removeimagetableaddedpicturestableforprojectscompanyandtaskstables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompanyPMO_.NET.Models.CompanyPicture", b =>
                {
                    b.Property<int>("CompanyPictureId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("company_picture_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("CompanyPictureId"));
            ...
            modelBuilder.Entity("CompanyPMO_.NET.Models.ProjectPicture", b =>
                {
                    b.Property<int>("ProjectPictureId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("project_picture_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ProjectPictureId"));
            ...
            modelBuilder.Entity("CompanyPMO_.NET.Models.TaskPicture", b =>
                {
                    b.Property<int>("TaskPictureId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("task_picture_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("TaskPictureId"));
                    ...
                    b.HasKey("TaskPictureId");

                    b.HasIndex("EmployeeId");

                    b.HasIndex("TaskId");

                    b.ToTable("taskpictures");
                });
            ...
            modelBuilder.Entity("CompanyPMO_.NET.Models.Notification", b =>
                {
                    b.HasOne("CompanyPMO_.NET.Models.Employee", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CompanyPMO_.NET.Models.Employee", "Sender")
                        .WithMany()
